...
function isAdminE2ETestEvent(x,env){
  ...
  if(source==="admin_or_test"||String(meta.test_mode||"").startsWith("admin_")||String(meta.test_mode||"").startsWith("test_")||ref.includes("/admin"))return true;
