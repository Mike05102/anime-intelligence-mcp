...
function bazaarMetadataQualityRow(x,origin,env){
  ...
  if(example&&String(example.version||"")!==VERSION)issues.push(`stale_example_version:${String(example.version||"missing")}`);
