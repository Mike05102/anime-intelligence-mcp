  ...
  async fetch(request,env,ctx){
    ...
    try{
      ...
      if(url.pathname.startsWith("/admin/")){
        ...
        if(url.pathname==="/admin/multilingual-ambiguous-shopping-e2e-audit"&&request.method==="GET")return json(url.searchParams.get("batch")==="1"?await multilingualAmbiguousShoppingE2EBatchAudit(env):await multilingualAmbiguousShoppingE2EAudit(env,url));
